        ...
        <div style="display: flex;flex-direction: row">
            ...
            <div class="col-xxl-10 col-md-10">
                ...
                <div class="card info-card sales-card">
                    <h5 class="card-title p-3"> what are the Features of the Student Section
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="bi-caret-right-fill"> Create doctos accounts and provide the doctor with the
                                privilege over the subject that he teaches</li>
                            <br>
            ...
            <div class=" mx-4 mb-3 w-50">
                <img style="width:400px;border-radius: 100%;" src="images/img2.jpg">
                <img style="width:220px;border-radius: 60%;" src="images/1245_U1RVRElPIEtBVCAxODAtNzQ.jpg">
            </div>
        </div>
    </section>
@endsection
